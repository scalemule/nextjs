import { _ as RegisterRequest, p as ClientContext, U as User, v as LoginRequest, L as LoginResponse, c as ListFilesParams, t as ListFilesResponse, a8 as StorageFile, ae as UploadResponse } from './index-BoENfro3.mjs';
...
declare function resolveGatewayUrl(config: ServerConfig): string;
declare class ScaleMuleServer {
    ...
    flags: {
        evaluate: <T = unknown>(flagKey: string, context?: Record<string, unknown>, environment?: string, options?: {
            clientContext?: ClientContext;
        }) => Promise<{
            flag_id: string;
            flag_key: string;
        ...
        evaluateBatch: (flagKeys: string[], context?: Record<string, unknown>, environment?: string, options?: {
            clientContext?: ClientContext;
        ...
        evaluateAll: (context?: Record<string, unknown>, environment?: string, options?: {
            clientContext?: ClientContext;
        }) => Promise<Record<string, {
            flag_id: string;
            flag_key: string;
...
export { type ServerConfig as S, type VideoFailedEvent as V, type WebhookEvent as W, ScaleMuleServer as a, type VideoReadyEvent as b, type VideoTranscodedEvent as c, type VideoUploadedEvent as d, type WebhookRoutesConfig as e, createServerClient as f, createWebhookHandler as g, createWebhookRoutes as h, resolveGatewayUrl as i, parseWebhookEvent as p, registerVideoWebhook as r, verifyWebhookSignature as v };
